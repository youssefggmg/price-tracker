                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
                        <div className="lg:col-span-2">
                            <a href="javascript:void(0)">
                                <img src="/logo-no-background.png" alt="logo" className="w-44 mb-8"/>
                            </a>
                            <h2 className="text-gray-300 roboto-bold" >amazon price tracker</h2>
                            <br />
                            
                            <p className="text-gray-300 text-sm">
                            in our website we track the products in amazon website by the url and making  a chart of the prices for peopole to  help find the best time to buy
                            </p>
                        </div>
                        <div>
